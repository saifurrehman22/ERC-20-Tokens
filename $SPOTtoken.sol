...
// File: contracts/DefiSpot.sol


pragma solidity ^0.6.0;


contract DefiSpot is ERC20Permit, ERC20Burnable, Ownable {
    constructor(address _owner) public ERC20("$SPOT token", "$SPOT") EIP712("$SPOT token", "1") {
